    ...
    return (
        <div className="bg-gray-100 p-10 rounded-2xl">
         ...
         <div>
            ...
            <p className="text-[#131313CC] mt-5"> we believe in the power of stories to inspire, educate, and connect us all. Our mission is to foster a love of reading by curating a diverse selection of books that reflect the rich tapestry of human experience.</p>
         </div>
         <p className="text-xl font-medium mt-3">Thank you for supporting independent book selling, and we look forward to welcoming you soon!</p>
            ...
            <div className="text-center">
                <h1 className="text-2xl font-semibold text-center mt-5">Social Media Links</h1>
